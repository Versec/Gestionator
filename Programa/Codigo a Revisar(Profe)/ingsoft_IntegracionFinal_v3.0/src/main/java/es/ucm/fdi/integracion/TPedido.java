...
public class TPedido {
	...
	public String toString(){
		String s= this.Id+" " +this.emisor.toString()+" "+this.repartidor +" "+this.pagado
				+" "+this.receptor+ " "+this.Id+" "+this.metPago.toString()+" "
				+" "+this.SucursalSalida.toString()+" "+this.SucursalLlegada.toString()
				+" " +this.tipoDeEnvio.toString()+" "+this.puntoControl.toString()
				+" "+this.precio;
