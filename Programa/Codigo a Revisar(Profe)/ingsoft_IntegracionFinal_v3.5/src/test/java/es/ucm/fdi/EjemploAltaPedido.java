	...
	extends TestCase
{
	...
	public void testAltaPedidoAñadirGestionPedidos()
	{
		...
		TPedido pedido1 = new TPedido(cliente2, 2, true, "Random", "1111", MetPago.CONTRA_REEMBOLSO, new TSucursal("123", "Yo", "Calle Oculta", 1234),
				new TSucursal("123", "El", "Calle Torrijos", 2345), TipoEnvio.NORMAL, new TPControl("Mimente no da para mas",Localizacion.SUCURSAL_INICIO, EstadoActual.NOENVIADO ), 9);	
		TPedido pedido2 = new TPedido(cliente3, 2, true, "Random", "1112", MetPago.CONTRA_REEMBOLSO, new TSucursal("123", "Yo", "Calle Oculta", 1234),
				new TSucursal("123", "El", "Calle Torrijos", 2345), TipoEnvio.NORMAL, new TPControl("Mimente no da para mas",Localizacion.SUCURSAL_INICIO, EstadoActual.NOENVIADO ), 9);	
		...
		assertTrue("La base de datos debe contener dos elementos",pedido.getIds().size()==2);
		
		GPedido.AñadirPedido(pedido3);
		assertTrue("La base de datos debe conetener tres elementos",pedido.getIds().size()==3);
	}
	...
	public void testFalloAltaPedidoGestionPedidos()
	{
		...
		pedido1 = new TPedido(cliente2, 2, true, "Random", "1111", MetPago.TRANSFERENCIA, new TSucursal("123", "Yo", "Calle Oculta", 1234),
