	...
	extends TestCase
{
	...
	public void testCadenaEfectivo()
	{
		...
		/*Comprobacion de la entrada introducida, si se introduce un "si" se ha efectuado el pago
		 * si se introduce "no" no se efectua, y si es otra entrada cualquiera no se efectua el pago*/
	...
	public void testNumeroTarjeta()
	{
		...
		/*Comprueba que se introduzca solo una cadena de 16 digitos numericos*/
	...
	public void testCaducidadTarjeta()
	{
		...
		/*Comprueba que la fecha de caducidad de la tarjeta solo tenga dos campos separados por "/" con 
		 * dos digitos cada campo, siendo estos numericos y mayor o igual a la fecha actual del sistema*/
	...
	public void testCvcTarjeta()
	{
		...
		/*Comprueba que el cvc de la tarjeta sera de 3 digitos numericos*/
